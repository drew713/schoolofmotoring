...
function openSite()
{
	var ref = window.open('http://www.schoolofmotoringballymoney.co.uk', '_blank', 'location=yes');
...
{
	var ref = window.open('http://businesswebsitedesignireland.com', '_blank', 'location=yes');
    ref.addEventListener('loadstart', function(event) { alert(event.url); });	
